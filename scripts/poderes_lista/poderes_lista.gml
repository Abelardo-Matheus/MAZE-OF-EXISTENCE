...
ds_grid_add_upgrade("BORBOLETA",	-1, -1, "Uma borboleta mágica que distrai os inimigos por um curto período.",0); // Linha 8
ds_grid_add_upgrade("BOLHAS",		-1, -1, "Uma chuva de bolhas que estoura ao encostar nos inimigos.",0); // Linha 9
ds_grid_add_upgrade("USRO",			-1, -1, "Cria um ursinho de pelúcia gigante que bloqueia os inimigos por alguns segundos.",0); // Linha 10



function ds_grid_add_upgrade(_name, _script, _frequency, _description, _level){
	var _grid = global.upgrades_grid;
